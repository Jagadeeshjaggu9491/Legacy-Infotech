...
export default function AboutPage({ onOpenContact }) {
  ...
  const milestones = [
    { year: '2014', title: 'Company Founded', desc: 'Started as specialized IT consulting firm in Ameerpet, Hyderabad.' },
    { year: '2017', title: 'US Expansion', desc: 'Opened North America HQ in Austin, TX & launched US Healthcare RCM division.' },
    { year: '2020', title: 'Cloud & AI Innovation', desc: 'Certified AWS Premier Partner & launched proprietary Legacy Refactoring Accelerator.' },
  ...
  return (
    <div ref={pageRef} style={{ paddingTop: '120px', background: '#F8FAFC', color: '#0F172A', minHeight: '100vh' }}>
      <SEO
        title="About Us | Legacy Infotech - Enterprise Digital Transformation"
        description="Discover Legacy Infotech's decade of digital excellence, core engineering principles, global operations, and vision for enterprise cloud and AI modernization."
        keywords="About Legacy Infotech, Company History, Engineering Principles, Global Footprint, Enterprise Digital Transformation"
      />
      ...
      <section style={{ padding: '4rem 0 3rem 0', background: 'linear-gradient(180deg, #FFFFFF 0%, #F8FAFC 100%)' }}>
        <div className="container gsap-animate-block" style={{ textAlign: 'center', maxWidth: '850px' }}>
          <div className="badge badge-purple" style={{ marginBottom: '1rem', background: 'rgba(0, 82, 204, 0.08)', color: '#0052CC', padding: '0.4rem 1.1rem', borderRadius: '50px', border: '1px solid rgba(0, 82, 204, 0.2)', display: 'inline-flex', alignItems: 'center', gap: '0.4rem', fontSize: '0.85rem', fontWeight: 700 }}>
            <Sparkles size={14} /> ABOUT LEGACY INFOTECH
          </div>
          ...
          <p style={{ fontSize: '1.15rem', color: '#475569', lineHeight: 1.75 }}>
            Legacy Infotech empowers global organizations to replace rigid legacy monoliths with cloud-native, high-velocity digital products, AI automation pipelines, and resilient business operations.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="gsap-animate-block" style={{ textAlign: 'center', marginBottom: '4rem' }}>
            ...
            <h2 style={{ fontFamily: "'Sora', sans-serif", fontSize: 'clamp(2.2rem, 4vw, 3rem)', fontWeight: 800, marginTop: '0.4rem', color: '#FFFFFF' }}>
              A Decade of Digital Excellence & Growth
            </h2>
          </div>
