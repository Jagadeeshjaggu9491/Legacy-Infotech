  ...
  return (
    ...
    >
      <div className="container">
        ...
        >
          ...
          <div style={{ gridColumn: 'span 1' }}>
            ...
            <p style={{ fontSize: '0.88rem', color: '#94A3B8', lineHeight: 1.6, marginBottom: '1.5rem' }}>
              Legacy Infotech is a leading IT and business solutions provider empowering global companies to innovate, integrate and achieve enterprise excellence.
            </p>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.9rem', fontSize: '0.86rem', color: '#94A3B8' }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.6rem' }}>
                <MapPin size={18} color="#0052CC" style={{ flexShrink: 0, marginTop: '2px' }} />
                <span>Unit No.407, 4th Floor, Jain Sadguru Images Capital Park, Image Gardens Rd, Madhapur, Hyderabad-81, Telangana.</span>
              </div>
        ...
        >
          <div>
            © 2026 Legacy Infotech. All Rights Reserved.
          </div>
